...
- Timestamp: `2022-05-12 01:57`
- Build ID: `f8d2e40c-598e-4f8b-b411-0df1c40ed865`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f8d2e40c-598e-4f8b-b411-0df1c40ed865.git
$ cd f8d2e40c-598e-4f8b-b411-0df1c40ed865
```
